...
```{r}
#| tbl-cap: Lasers of file1.
parse_lasers(laser1)
```

```{r}
#| tbl-cap: Lasers of file2.
parse_lasers(laser2)
```
...
Why are the spill matrices equal to the identity matrix? Shouldn't at least the conventional
flow frame (file 3) need it for computing compensation?
